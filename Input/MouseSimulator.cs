...
namespace Starship.Win32.Input {
    ...
    public class MouseSimulator : IMouseSimulator {
        ...
        public IMouseSimulator MoveMouseTo(double absoluteX, double absoluteY) {
            var inputList = new InputBuilder().AddAbsoluteMouseMovement((int) System.Math.Truncate(absoluteX), (int) System.Math.Truncate(absoluteY)).ToArray();
            SendSimulatedInput(inputList);
            return this;
        }
        ...
        public IMouseSimulator MoveMouseToPositionOnVirtualDesktop(double absoluteX, double absoluteY) {
            var inputList = new InputBuilder().AddAbsoluteMouseMovementOnVirtualDesktop((int) System.Math.Truncate(absoluteX), (int) System.Math.Truncate(absoluteY)).ToArray();
            SendSimulatedInput(inputList);
            return this;
        }
